...
const Cart = () => {
  ...
  // @ts-ignore
  const{cartitems,food_list,removeItemFromCart ,Totalitemcart} = useContext(StoreContext)
...
<div className="w-full max-w-4xl mx-auto mt-5 p-4 md:p-8 bg-[#f8f1f139] shadow-md rounded-lg">
  ...
  <div className="mt-6 bg-orange-500 p-4 rounded-lg shadow-sm">
    ...
    {/* Checkout Button */}
    <button className="w-full bg-white hover:bg-slate-200 text-orange-600 font-medium py-2 rounded mt-4 transition duration-200">
      PROCEED TO CHECKOUT
    </button>
  </div>

    ...
    <nav className="w-full md:bg-[#fff] border-spacing-1 border-y-2   ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-12 md:h-14">
          ...
          <div className="nav-right flex space-x-5  h-7">
            ...
            <button
              ...
              className="md:w-[8vw] md:h-9 bg-orange-600 text-white rounded flex items-center justify-center hover:bg-orange-500 mt-[-3px] w-[18vw] text-[0.8rem]  "
            >
              Sign in
            </button>
          </div>
